import { getPendingApprovalCount } from '@/data/demo'
...
export function AppShell ({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-svh flex-col overflow-clip bg-background">
      ...
      <div className="flex min-h-0 flex-1 overflow-hidden">
        <Sidebar pendingApprovalCount={pendingApprovalCount} />
        <main className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-y-auto px-4 py-5 sm:px-6 sm:py-6 lg:p-8">
          {children}
        </main>
      </div>
    </div>
